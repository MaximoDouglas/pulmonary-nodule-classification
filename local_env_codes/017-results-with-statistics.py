...
s = open('data/features/dict_features_conv96_dense64_drop241_dense24_drop236.txt', 'r').read()
dict_features = eval(s)
random_seed = 0
...
for feature_file_name in feature_file_name_list:
    ...
    best_individual = dict_features[experiment_name]#population[0]
