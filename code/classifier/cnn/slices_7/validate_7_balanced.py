...
def data():
    X_train = np.load("../data-7-balanced/X_train.npy")
    X_test = np.load("../data-7-balanced/X_test.npy")
    Y_train = np.load("../data-7-balanced/Y_train.npy")
    Y_test = np.load("../data-7-balanced/Y_test.npy")
