...
def data():
    X_train = np.load("../data-7-balanced-repeat/X_train.npy")
    X_test = np.load("../data-7-balanced-repeat/X_test.npy")
    Y_train = np.load("../data-7-balanced-repeat/Y_train.npy")
    Y_test = np.load("../data-7-balanced-repeat/Y_test.npy")
