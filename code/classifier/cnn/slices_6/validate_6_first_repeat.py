...
def data():
    X_train = np.load("../data-6-first-repeat/X_train.npy")
    X_test = np.load("../data-6-first-repeat/X_test.npy")
    Y_train = np.load("../data-6-first-repeat/Y_train.npy")
    Y_test = np.load("../data-6-first-repeat/Y_test.npy")
