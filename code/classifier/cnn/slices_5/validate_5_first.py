...
def data():
    X_train = np.load("../data-5-first/X_train.npy")
    X_test = np.load("../data-5-first/X_test.npy")
    Y_train = np.load("../data-5-first/Y_train.npy")
    Y_test = np.load("../data-5-first/Y_test.npy")
