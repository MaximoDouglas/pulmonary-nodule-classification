...
X = scaler.fit_transform(dataFrame[dataFrame.columns[2:73]])
...
Using the following array (already considering the exam_id and the nodule_id):
      [2, 3, 4, 6, 9, 11, 12, 18, 19, 22, 26, 28, 29, 
