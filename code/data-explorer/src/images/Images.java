...
public class Images {
	...
	public void downloadImages_originalNodules_withAttributes(String rootPath, String tag) throws IOException {

		rootPath += "solid-nodules-with-att-original" + "/";
					...
					if (bignodule.containsField("marginAttributes3D") && bignodule.containsField("textureAttributes") 
						...
						for (int i_roi = 0; i_roi < roiList.size(); ++i_roi) {
							...
							if(malignancyName.equals("benigno") ){
								...
								getImage.generateImage(roi.getObjectId(tag), fileNameP1 + fileNameP2, ".dcm");
